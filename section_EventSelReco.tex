...
\FloatBarrier
		...
		\label{sssec:mva_intro} 
			...
			\label{EventSelReco:fig:a05_DataMC_vars_01}
			\end{figure}
			\FloatBarrier
			...
			\label{EventSelReco:fig:a05_DataMC_vars_02}
			\end{figure}
			\FloatBarrier
			...
			\label{EventSelReco:fig:a05_DataMC_vars_03}
			\end{figure}
			\FloatBarrier
			...
			\label{EventSelReco:fig:a05_DataMC_vars_04}
			\end{figure}
			\FloatBarrier
			...
			\label{EventSelReco:fig:a05_DataMC_vars_05}
			\end{figure}
			\FloatBarrier
			...
			\label{EventSelReco:fig:a05_DataMC_vars_06}
			\end{figure}
			\FloatBarrier
			...
			\label{EventSelReco:fig:a05_DataMC_vars_07}
			\end{figure}
			\FloatBarrier
	...
	\label{ssec:CR}
		...
		In the calculation of asymmetry of $t\bar{t}$, there are some effect from non-$t\bar{t}$ background diving in and causing spurious result. To study the background asymmetry effects from detector and reconstruction, and to subtract these effects from $t\bar{t}$ asymmetry calculation, there are 2 $\textbf{Control Region(CR)}$ samples introduced. Control region usually means a region which is orthogonal to signal region and also usually used to study the background in an analysis. The background estimation and study part is set in Chapter****. In the analysis, the first CR is a $\textbf{W+jets-dominant CR}$ samples:
