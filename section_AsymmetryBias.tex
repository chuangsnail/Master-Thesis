...
\label{sec:AsymBias}
	...
	\label{ssec:evts_mixing}
		...
		\begin{figure}[H]
		\centering{}
	    	\subfigure[Muon channel]{\includegraphics[width=0.85\textwidth]{Figures/Asym/artificial/a05_artificial_to_mix_mu.pdf}}\\
		\end{figure}
		\FloatBarrier
		\begin{figure}[H]
		\centering{}
	    	\subfigure[Electron channel]{\includegraphics[width=0.85\textwidth]{Figures/Asym/artificial/a05_artificial_to_mix_el.pdf}}\\
		\caption{}
